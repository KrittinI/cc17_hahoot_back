...
const heroData = [
    {
        title: "We are Hahoot !",
        detail: `The walnut wood card tray is precision milled to perfectly fit a stack of Focus cards. The powder coated steel divider separates active cards from new ones, or can be used to archive important task lists.`,
        quiz1: 1,
        quiz2: 21,
        quiz3: 31,
        quiz4: 41,
    ...
    },
    {
        ...
        detail: `The National Mathematics Day is celebrated on 22nd December to celebrate the birthday of eminent mathematician Srinivasa Ramanujan. It was designated by the Indian Government in 2011. Despite his lack of formal education, Ramanujan is noted as one of the greatest mathematicians of all time. `,
        quiz1: 1,
        quiz2: 2,
        quiz3: 3,
        quiz4: 4,
    ...
    },
    {
        ...
        detail: `Germany coach Julian Nagelsmann says Spain's Lamine Yamal is a "talented" and "fun" player - but questioned whether the teenager can cope with the demands of a high stakes Euro 2024 quarter-final.
...
The 16-year-old winger has provided two assists for Spain so far, just the third teenager on record (since 1980) to provide multiple assists in the competition after Enzo Scifo (1984) and Cristiano Ronaldo (2004).`,
    ...
    },
    {
        ...
        detail: `Peace cannot be kept by force; it can only be achieved by understanding.
...
Albert Einstein`,
    ...
    {
        title: "We are Anime fans !",
        detail: `“The strong should aid and protect the weak. Then, the weak will become strong, and they in turn will aid and protect those weaker than them. That is the law of nature.”—Tanjiro Kamado, Demon Slayer
`,
        quiz1: 41,
        quiz2: 42,
        quiz3: 43,
...
ref: https://www.visitzealandia.com/About`,
    ...
    {
        title: "Ed Sheeran VS Hooter",
        detail: `"Everything will be okay in the end. If it's not okay, then it's not the end."
― Ed Sheeran`,
        quiz1: 65,
        quiz2: 66,
        quiz3: 67,
